...
<head>
    ...
    <title>Eston's DevOps Lab</title>
...
<div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#">Eston's DevOps Lab</a>
        </div>
...
<div class="jumbotron">
    <div class="container">
        <h1>Aloha</h1>
        <p>This is Eston's DevOps Lab version 0.0.7.2 - Initial Docker deployment</p>
...
<div class="container">
    ...
    <footer>
        <p>&copy; Eston's devops lab 2021</p>
    </footer>
</div> <!-- /container -->
